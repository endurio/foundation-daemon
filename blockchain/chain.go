...
type BlockChain struct {
	...
	mainchainBlockCache     map[chainhash.Hash]*ndrutil.Block
...
// exceeded.
func (b *BlockChain) addOrphanBlock(block *ndrutil.Block) {
...
func (b *BlockChain) fetchMainChainBlockByNode(node *blockNode) (*ndrutil.Block, error) {
...
//
// This function is safe for concurrent access.
func (b *BlockChain) fetchBlockByNode(node *blockNode) (*ndrutil.Block, error) {
...
func (b *BlockChain) pushMainChainBlockCache(block *ndrutil.Block) {
...
func (b *BlockChain) connectBlock(node *blockNode, block, parent *ndrutil.Block, view *UtxoViewpoint, stxos []spentTxOut) error {
	...
	blockAndParent := []*ndrutil.Block{block, parent}
...
func (b *BlockChain) dropMainChainBlockCache(block *ndrutil.Block) {
	curHash := block.Hash()
	b.mainchainBlockCacheLock.Lock()
...
//
// This function MUST be called with the chain state lock held (for writes).
func (b *BlockChain) disconnectBlock(node *blockNode, block, parent *ndrutil.Block, view *UtxoViewpoint) error {
...
func countSpentRegularOutputs(block *ndrutil.Block) int {
...
func countSpentOutputs(block *ndrutil.Block) int {
...
func (b *BlockChain) reorganizeChainInternal(targetTip *blockNode) error {
	...
	var nextBlockToDetach *ndrutil.Block
	...
	var prevBlockAttached *ndrutil.Block
...
//
// This function MUST be called with the chain state lock held (for writes).
func (b *BlockChain) connectBestChain(node *blockNode, block, parent *ndrutil.Block, flags BehaviorFlags) (int64, error) {
...
//
// This function is safe for concurrent access.
func (b *BlockChain) BlockByHash(hash *chainhash.Hash) (*ndrutil.Block, error) {
	node := b.index.LookupNode(hash)
...
//
// This function is safe for concurrent access.
func (b *BlockChain) BlockByHeight(height int64) (*ndrutil.Block, error) {
...
type IndexManager interface {
	...
	// main chain.
	ConnectBlock(database.Tx, *ndrutil.Block, *ndrutil.Block, *UtxoViewpoint) error

	// DisconnectBlock is invoked when a block has been disconnected from
	// the main chain.
	DisconnectBlock(database.Tx, *ndrutil.Block, *ndrutil.Block, *UtxoViewpoint) error
}
...
func New(config *Config) (*BlockChain, error) {
	...
	b := BlockChain{
		...
		mainchainBlockCache:     make(map[chainhash.Hash]*ndrutil.Block),
