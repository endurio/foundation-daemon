...
func storeFilter(dbTx database.Tx, block *ndrutil.Block, f *gcs.Filter, filterType wire.FilterType) error {
...
func (idx *CFIndex) ConnectBlock(dbTx database.Tx, block, parent *ndrutil.Block, view *blockchain.UtxoViewpoint) error {
...
func (idx *CFIndex) DisconnectBlock(dbTx database.Tx, block, parent *ndrutil.Block, view *blockchain.UtxoViewpoint) error {
