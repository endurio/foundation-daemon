...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/endurio/ndrd/dcrutil/txsort)
...
```bash
$ go get -u github.com/endurio/ndrd/dcrutil/txsort
```
