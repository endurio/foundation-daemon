...
// for ndrd and other utilities provided in the same repository.
package version
...
var (
	...
	// build process with:
	// '-ldflags "-X github.com/endurio/ndrd/internal/version.PreRelease=foo"'
	...
	// build process with:
	// '-ldflags "-X github.com/endurio/ndrd/internal/version.BuildMetadata=foo"'
