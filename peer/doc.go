...
A quick overview of the major features peer provides are as follows:
 ...
 - Provides a basic concurrent safe Decred peer for handling endurio
...
caller to specify things such as the user agent name and version, the endurio
network to use, which services it supports, and callbacks to invoke when endurio
...
In order to do anything useful with a peer, it is necessary to react to endurio
...
For convenience, a callback hook for all of the currently supported endurio
